...
class UNet3Plus_CIN(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, emb_classes=2, CIN_affine=True, bilinear=True, feature_scale=4,
        ...
        self.b5 = CINBlock(self.UpChannels, emb_classes, CIN_affine)
        self.b6 = CINBlock(self.UpChannels, emb_classes, CIN_affine)
        self.b7 = CINBlock(self.UpChannels, emb_classes, CIN_affine)
        self.b8 = CINBlock(self.UpChannels, emb_classes, CIN_affine)
